...
interface ExperienceEditDrawerProps {
  open: boolean
...
export function ExperienceEditDrawer({
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange} direction="right">
      <DrawerContent className="sm:max-w-lg h-full">
        ...
        <ScrollArea className="flex-1 overflow-hidden">
          <div className="grid gap-4 p-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                <Label htmlFor="drawer-title">Job Title</Label>
                <Input
                  id="drawer-title"
                  value={form.title}
              ...
              <div className="grid gap-2">
                <Label htmlFor="drawer-employmentType">Employment Type</Label>
                <Select
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                <Label htmlFor="drawer-startDate">Start Date</Label>
                <Input
                  id="drawer-startDate"
              ...
              <div className="grid gap-2">
                <Label htmlFor="drawer-endDate">End Date</Label>
                <Input
                  id="drawer-endDate"
                  value={form.endDate || ""}
