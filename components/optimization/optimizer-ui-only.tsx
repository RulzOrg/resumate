...
export default function OptimizerUiOnly({
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="mb-8">
        <div className="mb-2">
          <SafeLink href="/dashboard" className="group inline-flex items-center gap-2 text-sm text-white/70 hover:text-white">
                ...
                <div className="border-t border-white/10 p-3 flex items-center justify-between">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {keywords.map((k) => (
                        <span key={k} className="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-2.5 py-1 text-xs group hover:bg-red-500/20 transition-colors">
                          <span>{k.replace(/^\w/, (c) => c.toUpperCase())}</span>
                          <button
        ...
        <div className="space-y-8 mt-8 lg:mt-0">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="pt-2">
                <div className="text-xs text-white/60 mb-1">Detected Keywords</div>
                {keywords.length > 0 ? (
                  <div className="flex flex-wrap gap-2">
                    {keywords.map((s) => (
                      <span key={s} className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/20 px-2.5 py-1 text-xs group hover:bg-red-500/20 transition-colors">
                  ...
                  <div className="text-xs text-white/40 italic">Run "Analyze with AI" to extract keywords</div>
                )}
              </div>
            </div>
          </div>
