...
export function TipsSection({ 
  ...
  return (
    <div className="bg-muted/50 ring-1 ring-border rounded-xl mt-5">
      {/* Header */}
      <div className="flex gap-2 md:px-4 border-b pt-2.5 pr-3 pb-2.5 pl-3 items-center justify-between">
          ...
          <ul className="space-y-2">
            {tips.map((tip, index) => (
              <li key={index} className="flex gap-2">
                <span className={`mt-0.5 inline-flex h-1.5 w-1.5 flex-none rounded-full ${styles.dotBg} ring-1 ring-offset-1 ring-offset-background`}></span>
