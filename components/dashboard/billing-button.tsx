...
export function BillingButton({ subscriptionStatus, subscriptionPlan }: BillingButtonProps) {
  ...
  return (
    <button 
      ...
      disabled={isLoading}
      className="mt-4 w-full text-center text-sm font-medium text-white/80 hover:text-white transition bg-white/10 rounded-full py-2 disabled:opacity-50 disabled:cursor-not-allowed"
    >
