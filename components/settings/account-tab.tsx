    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-border bg-card shadow-sm">
        <div className="px-4 py-3 border-b border-border">
          <h3 className="text-base font-medium tracking-tight font-geist text-foreground">Profile</h3>
        </div>
        <div className="p-4 space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <button className="inline-flex items-center gap-2 rounded-lg border border-border bg-secondary px-3 py-2 text-sm text-secondary-foreground hover:bg-secondary/80 transition">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs text-muted-foreground mb-1.5 font-geist">Email address</label>
              
              {/* Current Email Display */}
              <div className="flex items-center gap-2 mb-2">
                <div className="flex-1 flex items-center gap-2 rounded-lg bg-input border border-input px-3 py-2">
            ...
            <div>
              <label className="block text-xs text-muted-foreground mb-1.5 font-geist">Timezone</label>
              <select
                value={formData.timezone}
                onChange={(e) => setFormData({ ...formData, timezone: e.target.value })}
                className="w-full rounded-lg bg-input border border-input text-foreground px-3 py-2 focus:outline-none focus:ring-2 focus:ring-emerald-500/60 focus:border-emerald-500/60 text-sm"
              >
                {TIMEZONES.map((tz) => (
            ...
            <div>
              <label className="block text-xs text-muted-foreground mb-1.5 font-geist">Job focus</label>
              <select
