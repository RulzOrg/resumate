-- Create database schema for Resume Optimization Platform
-- This script creates all the necessary tables for the application

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Users table (extending the existing users_sync table structure)
-- Note: users_sync table already exists, we'll add missing columns
...
-- Target job URLs collected during onboarding
...
DROP TRIGGER IF EXISTS update_job_targets_updated_at ON job_targets;
