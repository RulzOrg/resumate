...
function getPricingTiers(): PricingTier[] {
  ...
  },
  {
    ...
    currency: 'USD',
    interval: 'month',
    stripePriceId: process.env.STRIPE_PRICE_PRO_MONTHLY || 'price_1234567890', // Replace with actual Stripe price ID
    features: [
  ...
  },
  {
    ...
    currency: 'USD',
    interval: 'month',
    stripePriceId: process.env.STRIPE_PRICE_ENTERPRISE_MONTHLY || 'price_0987654321', // Replace with actual Stripe price ID
    features: [
      'Everything in Pro',
...
// Export the tiers as computed values
export const pricingTiers = getPricingTiers()
export const annualPricingTiers = getAnnualPricingTiers()
