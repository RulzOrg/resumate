  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <nav className="mt-6 flex items-center justify-between">
            ...
            <div className="hidden gap-1 md:flex bg-surface-subtle border-border/80 border rounded-full p-1 backdrop-blur items-center">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger className="group inline-flex items-center gap-1 px-4 py-2 text-sm font-medium text-foreground/90 hover:text-foreground font-sans focus:outline-none">
                  Resources
                ...
                <DropdownMenuContent
                  align="center"
                  sideOffset={12}
                  className="w-auto min-w-[320px] p-0 border-2 border-neutral-200 bg-background rounded-2xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)]"
                >
                  <ResourcesMegaMenu />
                </DropdownMenuContent>
              </DropdownMenu>
              ...
              <div className="py-6 px-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 88px)' }}>
                <div className="space-y-3">
                  ...
                  >
                    <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-colors">
                      <Upload className="h-5 w-5 text-primary/90" />
                    </div>
                    <div className="flex-1">
                      <div className="text-foreground font-sans">How It Works</div>
                      <div className="text-sm text-muted-foreground">Simple 3-step process</div>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-muted-foreground">Powerful AI tools</div>
                    </div>
                  </a>
                ...
                <div className="mt-8 pt-8 border-t border-border">
                  <div className="space-y-4">
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-primary/90 to-primary/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          ...
          <section className="relative z-10 max-w-5xl text-center mx-auto pt-14 pb-12 sm:pt-20 md:pt-28">
            ...
            <div className="mb-6 flex flex-wrap items-center justify-center gap-3">
              <span className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-surface-subtle px-4 py-2 text-sm font-medium text-foreground/80 font-sans">
                AI-Powered
              </span>
              <span className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-surface-subtle px-4 py-2 text-sm font-medium text-foreground/80 font-sans">
                ATS-Optimized
            ...
            <div className="flex flex-col gap-3 sm:flex-row mt-8 items-center justify-center">
              <Link
                href={isSignedIn ? "/dashboard" : "/auth/signup"}
                className="inline-flex items-center gap-2 shadow-[0_0_0_1px_rgba(255,255,255,0.08)_inset] text-base font-medium text-primary-foreground bg-primary rounded-full py-3 px-6 hover:bg-primary/90 transition-colors font-sans"
              >
                {isSignedIn ? "Open Dashboard" : "Get Started for Free"}
              </Link>
              <a
                href="#how-it-works"
                className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-surface-subtle px-6 py-3 text-base font-medium text-foreground/90 backdrop-blur hover:bg-surface-muted font-sans"
              >
                Learn More
              </a>
            </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 mt-16 sm:mt-24">
        <p className="mb-8 text-center text-sm font-medium text-muted-foreground/70 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <div className="mt-8 space-y-6">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-surface-subtle border border-border/80 ">
                    <Upload className="h-5 w-5 text-primary/90" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-surface-subtle border border-border/80 ">
                    <Target className="h-5 w-5 text-primary/90" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-surface-subtle border border-border/80 ">
                    <Download className="h-5 w-5 text-primary/90" />
                  </div>
                  <div>
            ...
            <div className="relative">
              <div className="relative aspect-[4/3] w-full bg-gradient-to-br from-primary/20 to-blue-500/20 border-border border rounded-2xl overflow-hidden">
                <Image 
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-20">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="group relative overflow-hidden rounded-2xl border border-border/80 bg-surface-subtle md:col-span-2 md:row-span-2 p-6 flex flex-col">
            ...
            <div className="mt-6 rounded-lg overflow-hidden border border-border">
              <div className="relative w-full aspect-[16/9] bg-gradient-to-br from-primary/20 to-blue-500/20">
                <Image 
          ...
          <div className="relative overflow-hidden rounded-2xl border border-border/80 bg-surface-subtle p-6">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-border/80 bg-surface-subtle p-6">
            ...
            <div className="mt-4 rounded-lg overflow-hidden border border-border">
              <div className="relative aspect-[16/10] w-full bg-gradient-to-br from-primary/20 to-green-500/20">
                <Image 
          ...
          <div className="relative overflow-hidden bg-surface-subtle border-border/80 border rounded-2xl p-6">
            <h3 className="text-lg font-medium tracking-tight flex items-center gap-2 font-sans">
      ...
      <section className="relative overflow-hidden py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="relative overflow-hidden p-6 bg-surface-subtle border-border/80 border rounded-2xl backdrop-blur-xl">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-foreground/5  border border-border/80 ">
      ...
      <section id="pricing" className="py-16 sm:py-24 px-4">
        <div className="relative max-w-7xl mx-auto">
          <div className="relative max-w-4xl mx-auto text-center">
            <h2 className="text-4xl sm:text-5xl text-foreground tracking-tight font-space-grotesk font-semibold">
          ...
          <div className="relative max-w-4xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Free */}
            <article className="relative overflow-hidden rounded-2xl border border-border/80 bg-surface-subtle p-8">
              <div className="flex-1">
                <h3 className="text-xl text-foreground font-medium tracking-tight font-sans">Free</h3>
                <p className="mt-4 text-sm text-muted-foreground font-sans">Perfect for getting started with AI resume optimization.</p>
                <div className="mt-6 flex items-end gap-2">
                  <p className="text-4xl sm:text-5xl text-foreground tracking-tight font-space-grotesk font-semibold">$0</p>
                </div>
              </div>
              <ul className="mt-8 space-y-4 text-sm">
                <li className="flex items-center gap-3"><Check className="h-5 w-5 text-primary/90" /><span className="text-foreground/90 font-sans">3 resume optimizations / month</span></li>
                <li className="flex items-center gap-3"><Check className="h-5 w-5 text-primary/90" /><span className="text-foreground/90 font-sans">Basic job analysis</span></li>
                ...
                <li className="flex items-center gap-3"><Check className="h-5 w-5 text-primary/90" /><span className="text-foreground/90 font-sans">Export to PDF/Word</span></li>
                <li className="flex items-center gap-3"><Check className="h-5 w-5 text-primary/90" /><span className="text-foreground/90 font-sans">Community support</span></li>
              </ul>
              <Link href={isSignedIn ? "/dashboard" : "/auth/signup"} className="mt-8 inline-flex items-center justify-center h-11 w-full rounded-full bg-surface-muted border border-border/80text-sm font-medium hover:bg-surface-strong transition font-sans">{isSignedIn ? "Open Dashboard" : "Get Started"}</Link>
            </article>

            {/* Pro */}
            <article className="relative overflow-hidden rounded-2xl border border-primary/50 bg-surface-subtle p-8 ring-1 ring-ring">
              <div className="absolute top-0 right-0 m-4 inline-flex items-center px-3 py-1 rounded-full text-xs font-medium text-primary-foreground bg-primary/10 border border-primary/30 font-sans">Most Popular</div>
              <div className="flex-1">
                <h3 className="text-xl text-foreground font-medium tracking-tight font-sans">Pro</h3>
                <p className="mt-4 text-sm text-muted-foreground font-sans">Ideal for active job seekers and career changers.</p>
                <div className="mt-6 flex items-end gap-2">
                  <p className="text-4xl sm:text-5xl text-foreground tracking-tight font-space-grotesk font-semibold">$19</p>
                  <span className="text-muted-foreground text-sm mb-2 font-sans">/ month</span>
                </div>
              </div>
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="flex items-center gap-3"><Check className="h-5 w-5 text-primary/90" /><span className="text-foreground/90 font-sans">Export to PDF/Word/TXT</span></li>
              </ul>
              <ProCheckoutButton className="mt-8 inline-flex items-center justify-center h-11 w-full rounded-full bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition font-sans disabled:opacity-50 disabled:cursor-not-allowed" />
            </article>
          </div>
        </div>
      </section>
      ...
      <section id="faq" className="relative overflow-hidden pt-16 pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="mt-4 text-base text-muted-foreground font-sans">Expert answers about creating ATS-friendly resumes and landing more interviews with AI-powered tailoring.</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {[
              ...
              <div key={index} className="relative overflow-hidden rounded-xl border border-border/80 bg-surface-subtle">
                <button
                ...
                >
                  ...
                  <span
                    className={`flex-shrink-0 w-5 h-5 text-muted-foreground transition-transform duration-300 ${openFaq === index ? "rotate-45" : ""}`}
                  >
                ...
                >
                  <p className="px-5 pb-5 pt-0 text-sm text-muted-foreground font-sans">{faq.answer}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <footer className="border-t border-border">
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <p className="text-sm text-muted-foreground/70 font-sans">© {new Date().getFullYear()} Useresumate. All rights reserved.</p>
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-4">
                <Link href="/terms" className="text-sm text-muted-foreground hover:text-foreground font-sans">Terms</Link>
                <Link href="/privacy" className="text-sm text-muted-foreground hover:text-foreground font-sans">Privacy</Link>
                <Link href="/support" className="text-sm text-muted-foreground hover:text-foreground font-sans">Support</Link>
              </div>
              <div className="flex items-center gap-4">
                <a href="https://www.linkedin.com/company/useresumate/" target="_blank" rel="noopener noreferrer" aria-label="Follow us on LinkedIn" className="text-muted-foreground hover:text-foreground">
